    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 2350, y: groundY - 140, velocity: 4, health: 20, score: 0, image: "img/medkit.png", xScale: .33, yScale: .33, imageX: -31, imageY: -35  },
          { type: "reward", x: 1800, y: groundY - 140, velocity: 2, health: 0, score: 500, image: "img/dillbit.png", xScale: .24, yScale: .24, imageX: -28, imageY: -28  },
      ...
      },
      {
        ...
        speed: -3,
        gameItems: [
          { type: "trap", x: 500, y: groundY + 10, hitSize: 25, damage: 20, image: "img/trap.png", xScale: .35, yScale: .35, imageX: -39, imageY: -50 },
          { type: "ceilingTrap", x: 700, y: groundY - 120, hitSize: 25, damage: 20, image: "img/ceilingtrap.png", xScale: .36, yScale: .36, imageX: -39, imageY: -28 },
          { type: "trap", x: 800, y: groundY + 10, hitSize: 25, damage: 20, image: "img/trap.png", xScale: .35, yScale: .35, imageX: -39, imageY: -50 },
          { type: "trap", x: 950, y: groundY + 10, hitSize: 25, damage: 20, image: "img/trap.png", xScale: .35, yScale: .35, imageX: -39, imageY: -50 },
          { type: "ceilingTrap", x: 1200, y: groundY - 130, hitSize: 25, damage: 20, image: "img/ceilingtrap.png", xScale: .36, yScale: .36, imageX: -39, imageY: -28 },
          { type: "ceilingTrap", x: 1500, y: groundY - 120, hitSize: 25, damage: 20, image: "img/ceilingtrap.png", xScale: .36, yScale: .36, imageX: -39, imageY: -28 },
          { type: "trap", x: 1320, y: groundY + 10, hitSize: 25, damage: 20, image: "img/trap.png", xScale: .35, yScale: .35, imageX: -39, imageY: -50 },

          //{ type: "enemy", x: 600, y: groundY - 50, velocity: 5, damage: 10, score: 300, image: "img/zombie.png", xScale: 0.6, yScale: 0.6  },
          //{ type: "enemy", x: 1750, y: groundY - 50, velocity: 3.8, damage: 10, score: 300, image: "img/zombie.png", xScale: 0.6, yScale: 0.6  },
        ],
      },
    ];
